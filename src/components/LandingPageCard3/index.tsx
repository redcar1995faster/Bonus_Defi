...
type LandingPageCard3Props = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "h6" | "paragraphrg"
> &
  Partial<{ h6: string; paragraphrg: string }>;

const LandingPageCard3: React.FC<LandingPageCard3Props> = (props) => {
  return (
    <>
      <div className={props.className}>
        <div className="flex flex-col gap-[12.16px] items-start justify-start m-auto w-full">
          <Img
            ...
            src="images/img_cardicon03_1.svg"
            alt="cardiconThree"
          />
          <Text
