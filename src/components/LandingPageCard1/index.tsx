...
type LandingPageCard1Props = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "username" | "userdescription"
> &
  Partial<{ username: string; userdescription: string }>;

const LandingPageCard1: React.FC<LandingPageCard1Props> = (props) => {
  return (
    <>
      <div className={props.className}>
        <div className="flex flex-col gap-[12.16px] items-start justify-start m-auto w-full">
          <Img
            ...
            src="images/img_cardicon03_white_a700_36x36.svg"
            alt="cardiconThree"
          />
          <Text
...
LandingPageCard1.defaultProps = {
  username: "Project NO 02",
  userdescription:
