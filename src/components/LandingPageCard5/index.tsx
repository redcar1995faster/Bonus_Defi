...
type LandingPageCard5Props = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "projectnumber" | "projectdescription"
> &
  Partial<{ projectnumber: string; projectdescription: string }>;

const LandingPageCard5: React.FC<LandingPageCard5Props> = (props) => {
  return (
    <>
      <div className={props.className}>
        <div className="flex flex-col gap-[12.16px] items-start justify-start m-auto w-full">
          <Img
            ...
            src="images/img_cardicon03_3.svg"
            alt="cardiconThree"
          />
          <Text
